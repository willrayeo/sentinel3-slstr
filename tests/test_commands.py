...
from stactools.sentinel3_slstr.commands import create_sentinel3slstr_command


class CommandsTest(CliTestCase):
    def create_subcommand_functions(self):
        return [create_sentinel3slstr_command]
    ...
    def test_create_collection(self):
        with TemporaryDirectory() as tmp_dir:
            ...
            result = self.run_command(
                ["sentinel3slstr", "create-collection", destination])
